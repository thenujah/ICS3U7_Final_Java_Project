...
//	public ArrayList<ArrayList<Object>> connections = new ArrayList<>(); // Remove
...
//				width = height = TILE_SIZE * scale;
	...
	public void addEntrance(String direction, TileMap connectingRoom) {
		...
		do {
			...
			if (positionSet)
				doors.add(new Object[]{ new Collider(coordinates[0], coordinates[1], width, height), connectingRoom, direction });
