...
public class TileMap {
	...
	public TileMap() {
		...
		int times = TILE_SIZE * scale;
		
		rect = new Rect(0, 0, (right - left + 3) * times, (bottom - top + 3) * times);
		rect.setCenter(Positioning.SCREEN_CENTER_X, Positioning.SCREEN_CENTER_Y);
		tanslation = new int[]{rect.getX(), rect.getY()};
		
		System.out.println(tanslation[0] + " " + tanslation[1]);
	...
	public void render(Graphics2D g) {
		for (int y = 0; y < map.length; y++) {
			for (int x = 0; x < map[y].length; x++) {
				...
				transform.translate(x * TILE_SIZE * scale + tanslation[0],
									y * TILE_SIZE * scale + tanslation[1]);
				...
				switch (tile) {
				case 0:
					image = Tiles.GROUND.getImage();
					break;
				case 1:
					image = Tiles.LARGE_TOP_LEFT_CORNER.getImage();
					break;
				case 2: 
					image = Tiles.LARGE_BOTTOM_RIGHT_CORNER.getImage();
					break;
				case 3:
					image = Tiles.LARGE_TOP_RIGHT_CORNER.getImage();
					break;
				case 4:
					image = Tiles.LARGE_BOTTOM_LEFT_CORNER.getImage();
					break;
				case 5:
					image = Tiles.SMALL_BOTTOM_RIGHT_CORNER.getImage();
					break;
				case 6:
					image = Tiles.SMALL_BOTTOM_LEFT_CORNER.getImage();
					break;
				case 7:
					image = Tiles.SMALL_TOP_LEFT_CORNER.getImage();
					break;
				case 8:
					image = Tiles.SMALL_TOP_RIGHT_CORNER.getImage();
					break;
				case 9:
					image = Tiles.TOP_WALL.getImage();
					break;
				case 10:
					image = Tiles.RIGHT_WALL.getImage();
					break;
				case 11:
					image = Tiles.BOTTOM_WALL.getImage();
					break;
				case 12:
					image = Tiles.LEFT_WALL.getImage(); 
					break;
				default:
					image = null;
					break;
